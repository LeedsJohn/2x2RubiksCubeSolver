...
{
    {0, 3, 5, 1, 1, 3, 1, 1, 2, 0, 2, 2}, // R
    {0, 1, 5, 3, 1, 1, 1, 3, 2, 2, 2, 0}, // R'
    {1, 2, 3, 4, 0, 0, 0, 0, 1, 1, 1, 1}, // U
    {1, 4, 3, 2, 0, 0, 0, 0, 1, 1, 1, 1}, // U'
    {0, 4, 5, 2, 2, 4, 0, 1, 3, 0, 1, 2}, // F
    {0, 2, 5, 4, 2, 1, 0, 4, 3, 2, 1, 0}, // F'
    {0, 1, 5, 3, 0, 0, 0, 2, 3, 3, 3, 1}, // L
    {0, 3, 5, 1, 0, 2, 0, 0, 3, 1, 3, 3}, // L'
    {1, 4, 3, 2, 2, 2, 2, 2, 3, 3, 3, 3}, // D
    {1, 2, 3, 4, 2, 2, 2, 2, 3, 3, 3, 3}, // D'
    {0, 2, 5, 4, 0, 3, 2, 1, 1, 0, 3, 2}, // B
    {0, 4, 5, 2, 0, 1, 2, 3, 1, 2, 3, 0} // B'
}
